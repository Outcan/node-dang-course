  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function isObject(val) {
        return (
          val !== null && (typeof val === "undefined" ? "undefined" : _typeof(val)) === "object"
        );
      }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function loadPlaces(map) {
        ...
        _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function(res) {
          ...
          // When someone clicks on a marker and show info for that marker
          ...
          // Then zoom the map to fit the bounds of the markers
 ...
 */
     ...
     * DOMPurify. */
        ...
        var _parseConfig = function _parseConfig(cfg) {
          ...
          ALLOWED_TAGS =
            "ALLOWED_TAGS" in cfg ? _addToSet({}, cfg.ALLOWED_TAGS) : DEFAULT_ALLOWED_TAGS;
          ALLOWED_ATTR =
            "ALLOWED_ATTR" in cfg ? _addToSet({}, cfg.ALLOWED_ATTR) : DEFAULT_ALLOWED_ATTR;
